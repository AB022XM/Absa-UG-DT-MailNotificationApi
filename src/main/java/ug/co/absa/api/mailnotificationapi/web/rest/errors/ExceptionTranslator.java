package ug.co.absa.api.mailnotificationapi.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ug.co.absa.api.mailnotificationapi.service.EmailAlreadyUsedException ||
            ex instanceof ug.co.absa.api.mailnotificationapi.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof ug.co.absa.api.mailnotificationapi.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(
            ...
            "io.",
            "de.",
            "ug.co.absa.api.mailnotificationapi"
        );
    }
}
