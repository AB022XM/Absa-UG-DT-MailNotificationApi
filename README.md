...
To build the final jar and optimize the MailNotificationApi application for production, run:
...
Then navigate to [http://localhost:9989](http://localhost:9989) in your browser.
